-- Force drop and recreate all stored procedures
-- This ensures the procedures are updated correctly

-- Drop existing procedures
DROP FUNCTION IF EXISTS deduct_balance_for_bet(TEXT, NUMERIC, TEXT);
DROP FUNCTION IF EXISTS apply_balance_for_payout(TEXT, NUMERIC, TEXT, TEXT);
DROP FUNCTION IF EXISTS update_balance_for_deposit(TEXT, NUMERIC, TEXT, TEXT);
DROP FUNCTION IF EXISTS update_balance_for_withdrawal(TEXT, NUMERIC, TEXT, TEXT);

-- 1. deduct_balance_for_bet
CREATE FUNCTION deduct_balance_for_bet(
    p_user_address TEXT,
...
CREATE FUNCTION apply_balance_for_payout(
    p_user_address TEXT,
...
CREATE FUNCTION update_balance_for_deposit(
    p_user_address TEXT,
...
CREATE FUNCTION update_balance_for_withdrawal(
    p_user_address TEXT,
