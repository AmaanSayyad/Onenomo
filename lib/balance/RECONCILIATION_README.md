...
**Note:** This assumes the BynomoGame contract has a `getUserBalance(userAddress: Address)` function. If the contract doesn't track individual user balances, this will need to be implemented differently.
