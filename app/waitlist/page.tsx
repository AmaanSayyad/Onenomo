...
const faqs = [
    ...
    },
    {
        ...
        answer: "Onenomo supports a wide range of assets including major cryptos (BTC, ETH, SOL), precious metals (Gold, Silver), and top-tier stocks (AAPL, NVDA, TSLA) through Pyth price feeds."
    },
    {
    ...
    return (
        <main className="landing-layout selection:bg-purple-500/30">
            ...
            <footer className="py-24 px-10 border-t border-white/5 bg-black relative z-10 w-full overflow-hidden">
                <div className="huge-footer-logo text-[12vw] opacity-[0.03]">ONENOMO</div>
