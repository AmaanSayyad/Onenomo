            ...
            >
              ...
              <div className="relative flex-1">
                <div className="flex items-center gap-2">
                  <h3 className="text-white font-bold text-base tracking-tight">OneChain Testnet</h3>
                ...
                <p className="text-gray-500 text-[11px] mt-0.5 font-medium">One Wallet, MetaMask, Trust Wallet</p>
              </div>
